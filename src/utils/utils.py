...
def consistency_loss(logits_s, logits_w, conf_acc, x_ulb_idx, aum_calculator, y_ulb, crt_threshold, num_classes,
                     threshold_mask, name='ce',
                     T=1.0, p_cutoff=0.0, use_hard_labels=True, labels=True):
    ...
    return masked_loss, select_confidence, max_idx.long()
